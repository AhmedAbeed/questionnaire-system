...
class FacultyDeanDashboardService extends BaseService
{
    /**
    ...
    private function getActiveQuestionnaires()
    {
        try {
            ...
            logError('Failed to retrieve active questionnaires', 'FacultyDeanDashboardService', $e);
            throw $e;
        }
    }
    ...
    public function getStats(): array
    {
        try {
            ...
            logError('Failed to retrieve stats', 'FacultyDeanDashboardService', $e);
            throw new ServiceException('Unable to retrieve faculty dean dashboard statistics due to system error', 0, $e);
        }
    }
    ...
    public function getChartData(): array
    {
        try {
            ...
            logError('Failed to retrieve chart data', 'FacultyDeanDashboardService', $e);
