...
use App\Services\FacultyDeanDashboardService;
use Exception;
...
class FacultyDeanDashboardController extends Controller
{
    protected $dashboardService;

    public function __construct(FacultyDeanDashboardService $dashboardService)
    {
    ...
    {
        try {
            return view('dashboard.faculty-dean');
        } catch (Exception $e) {
            logError('Error fetching dashboard data', 'FacultyDeanDashboardController', $e);
            abort(500);
        }
    }
    ...
    public function getChartData()
    {
        try {
            ...
            logError('Error fetching chart data', 'FacultyDeanDashboardController', $e);
